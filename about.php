      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown mb-0">GROUP 3</h2><p>CE0 <a href="https://github.com/bernaaax" target="_blank">@GROUP3</a></p>
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Get Started</a>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.1s">
            <div class="member">
              <img src="assets/img/team/team-1.jpg" style="height: 198px;width: 198px; class="img-fluid" alt="" >
              <div class="member-info">
                ...
                <div class="social">
                  ...
                  <a href="https://github.com/bernaaax" target="_blank"><i class="fab fa-github"></i></a>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.2s">
            <div class="member">
              <img src="assets/img/team/team-2.jpg" style="height: 198px;width: 198px; class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Reymina Q. Nanaring</h4>
                </div>
                <div class="social">
                  <a href=""><i class="icofont-twitter" target="_blank"></i></a>
                  <a href="https://github.com/Rnanaring" target="_blank"><i class="fab fa-github"></i></a>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.2s">
            <div class="member">
              <img src="assets/img/team/team-4.jpg" class="img-fluid" alt="" style="height: 198px;width: 198px;">
              <div class="member-info">
                <div class="member-info-content">
