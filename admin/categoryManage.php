        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <form action="partials/_categoryManage.php" method="post" enctype="multipart/form-data">
                    <div class="card">
                        <div class="card-header" style="background-color:#910808; color: white; border: .5px solid transparent;">
                            Create New Category
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-md-12">
                                    <button type="submit" name="createCategory" class="btn btn-sm btn-primary col-sm-3 offset-md-4" style="background-color: #910808; border: .5px solid transparent;"> Create </button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                echo '<tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button class="btn btn-sm btn-primary edit_cat" type="button" data-toggle="modal" data-target="#updateCat' .$catId. '" style="background-color: #eca307; border: .5px solid transparent;">Edit</button>
                                            <form action="partials/_categoryManage.php" method="POST">
                                                <button name="removeCategory" class="btn btn-sm btn-danger" style="margin-left:9px; background-color: #910808; border: .5px solid transparent;">Delete</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="partials/_categoryManage.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
		   		<div class="form-group col-md-8">
					...
					<button type="submit" class="btn btn-success my-1" name="updateCatPhoto" style="background-color: #910808; border: .5px solid transparent;">Update Image</button>
				</div>
        ...
        <form action="partials/_categoryManage.php" method="post">
            ...
            <input type="hidden" id="catId" name="catId" value="<?php echo $catId; ?>">
            <button type="submit" class="btn btn-success" name="updateCategory" style="background-color: #910808; border: .5px solid transparent;">Update</button>
        </form>
      </div>
    </div>
  </div>
