...
<style>
    .btn-danger-gradiant {
        background-color: #910808; border: .5px solid transparent; margin-bottom: 25px; 
    }
                            ...
                            while($row=mysqli_fetch_assoc($result)) {
                                ...
                                echo '<tr>
                                        ...
                                        <td class="text-center">
                                            <button class="btn btn-sm btn-primary" type="button" data-toggle="modal" data-target="#reply' .$contactId. '" style="background-color: #910808; border: .5px solid transparent;">Reply</button>
                                        </td>
                                    </tr>';
                            }
                            if($count==0) {
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="partials/_contactManage.php" method="post">
                ...
                <button type="submit" class="btn btn-success" name="contactReply" style="background-color: #910808; border: .5px solid transparent;">Reply</button>
            </form>
          </div>
        </div>
      </div>
