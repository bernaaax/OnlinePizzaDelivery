...
echo '<div class="container-fluid" style="padding-left: 470px;margin-top:98px">
	<div class="card col-lg-6 p-0">
        <div class="title" style="background-color: #910808; color: white;">
		...
		<div class="card-body">
			<form action="partials/_siteManage.php" method="post">
                ...
                <center>
                    <button name="updateDetail" class="btn btn-info btn-primary btn-block col-md-2" style="background-color: #910808; border: .5px solid transparent;">Save</button>
                </center>
            </form>
		</div>
	</div>';
