	...
	<div class="col-lg-12">
		<div class="row">
			...
			<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
				<div class="card mb-3">
					<div class="card-header" style="background-color: #910808; color: white;">
						Create New Item
				  	</div>
					<div class="card-body">
					...
					<div class="card-footer">
						<div class="row">
							<div class="mx-auto">
								<button type="submit" name="createItem" class="btn btn-sm btn-primary" style="background-color: #910808; border: .5px solid transparent;"> Create </button>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="card">
					<div class="card-body">
						<table class="table table-bordered table-hover mb-0">
							<thead style="background-color: #910808; color: white;">
								<tr>
									<th class="text-center" style="width:7%;">Category ID</th>
									<th class="text-center">Image</th>
									<th class="text-center" style="width:58%;">Item Details</th>
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    echo '<tr>
                                            ...
                                            <td>
                                                ...
                                                <p>Price : <b>Php ' .$pizzaPrice. '.00</b></p>
                                            </td>
                                            <td class="text-center">
												<div class="row mx-auto" style="width:112px">
													<button class="btn btn-sm btn-primary" type="button" data-toggle="modal" data-target="#updateItem' .$pizzaId. '" style="background-color: #eca307; border: .5px solid transparent;">Edit</button>
													<form action="partials/_menuManage.php" method="POST">
														<button name="removeItem" class="btn btn-sm btn-danger" style="margin-left:9px; background-color: #910808; border: .5px solid transparent;">Delete</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
	  	<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
		   		<div class="form-group col-md-8">
					...
					<button type="submit" class="btn btn-success my-1" name="updateItemPhoto" style="background-color: #910808; border: .5px solid transparent;">Update Image</button>
				</div>
		...
		<form action="partials/_menuManage.php" method="post">
            ...
            <input type="hidden" id="pizzaId" name="pizzaId" value="<?php echo $pizzaId; ?>">
            <button type="submit" class="btn btn-success" name="updateItem" style="background-color: #910808; border: .5px solid transparent;">Update</button>
        </form>
      </div>
    </div>
  </div>
