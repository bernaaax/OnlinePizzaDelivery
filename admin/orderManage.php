<div class="container" style="margin-top:100px;background: aliceblue;">
    <div class="table-wrapper">
        <div class="table-title" style="border-radius: 14px;">
            <div class="row">
                ...
                <div class="col-sm-8">						
                    <a href="" class="btn btn-primary" style="background-color: #910808; border:.5px solid transparent; border-radius: 25px;"><i class="material-icons">&#xE863;</i> <span>Refresh List</span></a>
