		...
		<div class="card col-lg-12">
			<div class="card-body">
				<table class="table-striped table-bordered col-md-12 text-center">
                    <thead style="background-color: #910808; color: white;s">
                        <tr>
                            <th>User ID</th>
                                ...
                                echo '<tr>
                                    ...
                                    <td class="text-center">
                                        <div class="row mx-auto" style="width:112px">
                                            <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#editUser' .$Id. '" type="button" style="background-color: #eca307; border: .5px solid transparent;">Edit</button>';
                                            if($Id == 1) {
                                                echo '<button class="btn btn-sm btn-danger" disabled style="margin-left:9px; background-color: #910808; border: .5px solid transparent;">Delete</button>';
                                            }
                                            else {
...
<div class="modal fade" id="newUser" tabindex="-1" role="dialog" aria-labelledby="newUser" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #910808; color: white;">
      ...
      <div class="modal-body">
        <form action="partials/_userManage.php" method="post">
              ...
              <div class="form-group row my-0">
                    <div class="form-group col-md-6 my-0">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="tel" class="form-control" id="phone" name="phone" placeholder="Enter Phone No" required pattern="[0-9]{11}" maxlength="10">
                        </div>
                    </div>
                    <div class="form-group col-md-6 my-0">
              ...
              <button type="submit" name="createUser" class="btn btn-success" style="background-color: #910808; border: .5px solid transparent;">Submit</button>
            </form>
      </div>
    </div>
  </div>
      ...
      <div class="modal-header" style="background-color: #910808; color: white;">
        ...
        <div class="modal-body">
            ...
            <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
                <div class="form-group col-md-8">
                    <form action="partials/_userManage.php" method="post" enctype="multipart/form-data">
                        ...
                        <small id="Info" class="form-text text-muted mx-3">.jpg file upload.</small>
                        <input type="hidden" id="userId" name="userId" value="<?php echo $Id; ?>">
                        <button type="submit" class="btn btn-success mt-3" name="updateProfilePhoto" style="background-color: #910808; border: .5px solid transparent;">Update Image</button>
                    </form>         
                </div>
                <div class="form-group col-md-4">
                    ...
                    <form action="partials/_userManage.php" method="post">
                        <input type="hidden" id="userId" name="userId" value="<?php echo $Id; ?>">
                        <button type="submit" class="btn btn-success mt-2" name="removeProfilePhoto" style="background-color: #910808; border: .5px solid transparent;">Remove Image</button>
                    </form>
                </div>
            </div>
            ...
            <form action="partials/_userManage.php" method="post">
                ...
                <div class="form-group row my-0">
                    <div class="form-group col-md-6 my-0">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="tel" class="form-control" id="phone" name="phone" value="<?php echo $phone; ?>" required pattern="[0-9]{11}" maxlength="10">
                        </div>
                    </div>
                    <div class="form-group col-md-6 my-0">
                        <b><label for="userType">Type:</label></b>
                ...
                <input type="hidden" id="userId" name="userId" value="<?php echo $Id; ?>">
                <button type="submit" name="editUser" class="btn btn-success" style="background-color: #910808; border: .5px solid transparent;">Update</button>
            </form>
        </div>
    </div>
  </div>
