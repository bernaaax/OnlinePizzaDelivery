...
<div class="modal fade" id="orderStatus<?php echo $orderid; ?>" tabindex="-1" role="dialog" aria-labelledby="orderStatus<?php echo $orderid; ?>" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #910808; color: white;s">
      ...
      <div class="modal-body">
        <form action="partials/_orderManage.php" method="post" style="border-bottom: 2px solid #dee2e6;">
            ...
            <button type="submit" class="btn btn-success mb-2" name="updateStatus" style="background-color: #910808; border: .5px solid transparent;">Update</button>
        </form>
        <?php 
            ...
            <form action="partials/_orderManage.php" method="post">
                ...
                <div class="text-left my-2 row">
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control" id="phone" name="phone" value="<?php echo $deliveryBoyPhoneNo; ?>" type="tel" required pattern="[0-9]{11}">
                    </div>
                    <div class="form-group col-md-6">
                ...
                <input type="hidden" id="orderId" name="orderId" value="<?php echo $orderid; ?>">
                <button type="submit" class="btn btn-success" name="updateDeliveryDetails" style="background-color: #910808; border: .5px solid transparent;">Update</button>
            </form>
        <?php } ?>
      </div>
    </div>
