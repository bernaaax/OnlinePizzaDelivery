                          ...
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="tel" class="form-control" id="phone" name="phone" aria-describedby="basic-addon" placeholder="Enter Your Phone Number" required pattern="[0-9]{11}" value="<?php echo $phone ?>">
                                </div>
                            </div>
                          </div>
                          <div class="col-lg-6">
