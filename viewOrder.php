...
<body>
    ...
    <div class="container">
        <div class="table-wrapper" id="empty">
            <div class="table-title" style="background-color:#910808; border: .5px solid transparent; border-radius: 25px;">
                <div class="row" >
                    <div class="col-sm-4" >
                        <h2>Order <b>Details</b></h2>
                    </div>
                    <div class="col-sm-8">						
                        <a href="" class="btn btn-primary" style="background-color:#eca307; border: .5px solid transparent;"><i class="material-icons">&#xE863;</i> <span>Refresh List</span></a>
            ...
            <table class="table table-striped table-hover text-center">
                ...
                <tbody>
                    <?php
                        ...
                        if($counter==0) {
                            ?><script> document.getElementById("empty").innerHTML = '<div class="col-md-12 my-5"><div class="card"><div class="card-body cart"><div class="col-sm-12 empty-cart-cls text-center"> <img src="https://i.imgur.com/dCdflKN.png" width="130" height="130" class="img-fluid mb-4 mr-3"><h3><strong>You have not ordered any items.</strong></h3><h4>Please order to make me happy :)</h4> <a href="index.php" class="btn btn-primary cart-btn-transform m-3" data-abc="true" style="background-color:#910808; border: .5px solid transparent;">continue shopping</a> </div></div></div></div>';</script> <?php
                        }
                    ?>
                </tbody>
            </table>
