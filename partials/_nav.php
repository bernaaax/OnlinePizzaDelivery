...
echo '<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form method="get" action="/OnlinePizzaDelivery/search.php" class="form-inline my-2 my-lg-0 mx-3">
          ...
          <button class="btn btn-outline-success my-2 my-sm-0" type="submit" style="background-color:#910808; border: .5px solid transparent; color: white;">Search</button>
        </form>';
        ...
        if($loggedin){
          ...
          echo '
          <button type="button" class="btn btn-success mx-2"  data-toggle="modal" data-target="#loginModal" style="background-color:#910808; border: .5px solid transparent;" >Login</button>
          <button type="button" class="btn btn-success mx-2"  data-toggle="modal" data-target="#signupModal" style="background-color:#910808; border: .5px solid transparent;">SignUp</button>';
        }
