                                ...
                                if($loggedin){
                                    ...
                                    if($quaExistRows == 0) {
                                        echo '<form action="partials/_manageCart.php" method="POST">
                                              ...
                                              <button type="submit" name="addToCart" class="btn btn-primary mx-2" style="background-color:#910808; border: .5px solid transparent;">Add to Cart</button>';
                                    }else {
                                        echo '<a href="viewCart.php"><button class="btn btn-primary mx-2" style="background-color:#910808; border: .5px solid transparent;">Go to Cart</button></a>';
                                    }
                                }
                                else{
                                    echo '<button class="btn btn-primary mx-2" data-toggle="modal" data-target="#loginModal" style="background-color:#910808; border: .5px solid transparent;">Add to Cart</button>';
                                }
                                echo '</form>
                                <a href="viewPizza.php?pizzaid=' . $pizzaId . '"><button class="btn btn-primary" style="background-color:#eca307; border: .5px solid transparent;">Quick View</button></a>
                            </div>
                        </div>
                    </div>
                </div>';
